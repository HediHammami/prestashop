...
class Ph_instagram extends Module
{
    ...
    public function getContent()
    {
        ...
        //Render views
        $this->renderConfig();
        return $success.$this->_html.$this->displayIframe();
    }
    ...
    public function renderConfig()
    {
        ...
        $helper->tpl_vars = array(
            ...
            'codeCronjob' => '* * * * * '.(defined('PHP_BINDIR') && PHP_BINDIR && is_string(PHP_BINDIR) ? PHP_BINDIR.'/' : '').'php '._PS_MODULE_DIR_.$this->name.'/cronjob.php?secure='.Configuration::getGlobalValue('PH_INSTAGRAM_CRONJOB_TOKEN')
        );
