...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
	{
       ...
       $this->configs = array(
            ...
            'YBC_SHOPMSG_WELCOME' => array(
                'label' => $this->l('Shop text welcome'),
                'type' => 'textarea',
                'default' => 1,
                'body_class' => true,
				...
				'options' => array(
        			 'query' => array(                             
                            array(
                                ...
                                'slides' => array(1,5),
                                'widgets' => array(71,70,77,83,84,85,73),
                                'menus' => array(6,7,8,9,11,12,10),
                            ),
                            array(
                            ...
                            array(
                                ...
                                'slides' => array(10,12),
                                'widgets' => array(88,90,89,91,92,93,94),      
                                'menus' => array(6,7,8,9,11,12,10),                                              
                            ),
                            array(
                                ...
                                'slides' => array(5,1),
                                'widgets' => array(95,96,97,98,99,100,73,86,87),
                                'menus' => array(6,7,8,9,11,12,10),                                               
                            ),
                            array(
                                ...
                                'slides' => array(8,9),
                                'widgets' => array(71,70,77,83,84,85,73,86,87),
                                'menus' => array(6,7,8,9,11,12,10),                                               
                            ),
                            array(
            ...
            'YBC_TC_WELCOME_FOOTER' => array(                
                'label' => $this->l('Footer text welcome'),
                'type' => 'textarea',
                'lang' => true,
                'group' => 'ybc_tab_footer',
                'default' => 'Welcome to BOOM, one of the best Responsive Prestashop theme',
                'lang' => true
            ),
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(                
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Copyright 2017 <a href="#">Boom Store Co., LTD.</a>  All rights reserved',
            ), 
            'YBC_TC_COPYRIGHT_TEXT_EXTRA' => array(                
                'label' => $this->l('Copyright text extra'),				
                'lang' => true,
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',                
                'default' => 'Website is proudly powered by <a class="_blank" href="http://www.prestashop.com">Prestashop</a>. All images used in the demo website are for preview purpose only and <br/>not included in the download file.',
            ), 
            ...
            'YBC_TC_FONT1_DATA' => array(                
                ...
                'data_type' => 'font',     
                'validate' => 'isString',
                'default' => 'https://fonts.googleapis.com/css?family=Ubuntu:300,300i,400,400i,500,500i,700,700i'                              
            ),              
            ...
            'YBC_TC_FONT2_DATA' => array(                
                ...
                'data_type' => 'font',  
                'validate' => 'isString',
                'default' => 'https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700'              
            ),              
    ...
    public function hookDisplayFooter()
    {
        ...
        $this->smarty->assign(array(                    
                    ...
                    'moduleDirl' => $this->getBaseModLink().'modules/'.$this->name.'/',
    ...
    public function getBaseModLink()
    {
