...
{if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome1' || $tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome4')}
<script type="text/javascript">
    var width_slider = 1170;
    var height_slider = 500;
</script>
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome2')}
<script type="text/javascript">
    var width_slider = {$mls_width|intval};
    var height_slider = {$mls_height|intval};
</script>
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome5')}
<script type="text/javascript">
    var width_slider = 793;
    var height_slider = 570;
</script>
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome6') }
<script type="text/javascript">
    var width_slider = 1523;
    var height_slider = 520;
</script>
{elseif isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome3') }
<script type="text/javascript">
    var width_slider = 1598;
    var height_slider = 488;
</script>
{else}
<script type="text/javascript">
    var width_slider = {$mls_width|intval};
...
{if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8' == 'LayoutHome5')}
<div class="box_slider5">
{/if}

<div class="ets_multilayerslider {if $mls_configs.ETS_MLS_SLIDER_TYPE=='full'}hidden{/if} 
{if isset($tc_config.YBC_TC_LAYOUT)}
{$tc_config.YBC_TC_LAYOUT|escape:'html':'UTF-8'}
{/if}
">
    <div class="mls_slides">
    <div data-max-slide-time="{$mls_max_slide_time|intval}" class="mls_slider {if $mls_configs.ETS_MLS_ENABLE_LOADING_ICON}loading{/if} {if isset($mls_configs.ETS_MLS_SLIDER_TYPE)}mls_slider_type_{strtolower($mls_configs.ETS_MLS_SLIDER_TYPE)|escape:'html':'UTF-8'}{/if} mls_layout_{$mls_layout|escape:'html':'UTF-8'}"
        style="{if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome1' || $tc_config.YBC_TC_LAYOUT == 'LayoutHome4')} width: 1170px; height: 500px; {/if}
                {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome2')} width: {$mls_width|intval}px; height: {$mls_height|intval}px;{/if}
                {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome5')} width: 793px; height: 570px;{/if}
                {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome3')} width: 1598px; height: 488px;{/if}
                {if isset($tc_config.YBC_TC_LAYOUT) && ($tc_config.YBC_TC_LAYOUT == 'LayoutHome6')} width: 1523px; height: 520px;{/if}
        {if $mls_configs.ETS_MLS_SLIDER_BACKGROUND}background-color: {$mls_configs.ETS_MLS_SLIDER_BACKGROUND|escape:'html':'UTF-8'};{/if}" {hook h='displayMLSConfigs'}>
                            ...
                            {if $layer.layer_type=='image' && $layer.image || $layer.layer_type!='image'&&$layer.content_layer}
                                <div class="msl_layer_front {if isset($layer.custom_class) && $layer.custom_class}{$layer.custom_class|escape:'html':'UTF-8'}{/if} msl_layer_{$layer.id_layer|intval} layer_layout_{$mls_layout|escape:'html':'UTF-8'} mls_layer_type_front_{$layer.layer_type|escape:'html':'UTF-8'}" style="position: absolute; {if $mls_layout=='rtl' && $mls_multilayout}right:{$layer.right|escape:'html':'UTF-8'}px; top:{$layer.top_right|escape:'html':'UTF-8'}px; left: auto;{else}left:{$layer.left|escape:'html':'UTF-8'}px; top:{$layer.top|escape:'html':'UTF-8'}px; right: auto;{/if} float:left; bottom: auto; z-index: {$layer.sort_order|intval};" data-top="{$layer.top|escape:'html':'UTF-8'}" data-id-layer="{$layer.id_layer|intval}"
                                    ...
                                    {elseif $layer.layer_type=='text' || $layer.layer_type=='link'}
                                        {if $layer.link && $layer.layer_type=='link'}<a href="{$layer.link|escape:'html':'UTF-8'}">{/if}<div style="
                                        ...
                                        ">{$layer.content_layer nofilter}</div>{if $layer.link && $layer.layer_type=='link'}</a>{/if}
                                    ...
                                    {elseif $layer.layer_type=='button'}
                                        {if $layer.link}<a href="{$layer.link|escape:'html':'UTF-8'}">{/if}<div style="
                                            {if $layer.font_size}font-size:{$layer.font_size|escape:'html':'UTF-8'}px{/if};
                                            {if $layer.text_color}color:{$layer.text_color|escape:'html':'UTF-8'};{/if}
                                            {if $layer.font_family}font-family:'{$layer.font_family|escape:'html':'UTF-8'}';{/if}
                                            {if $layer.font_weight}font-weight:{$layer.font_weight|escape:'html':'UTF-8'};{/if}
                                        ...
                                        ">{$layer.content_layer nofilter}</div>{if $layer.link|escape:'html':'UTF-8'}</a>{/if}
                                    {/if}
                                </div>
                            {/if}
                        {/foreach}                        
