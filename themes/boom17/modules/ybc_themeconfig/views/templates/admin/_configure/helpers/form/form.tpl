...
{block name="field"}   
    ...
    {elseif $input.type == 'file' &&  isset($input.display_img) && $input.display_img}
        ...
        <div class="col-lg-9">
    		<a  class="ybc_fancy" href="{$input.display_img|escape:'quotes':'UTF-8'}"><img title="{l s='Click to see full size image' mod='ybc_themeconfig'}" style="display: inline-block; max-width: 200px;" src="{$input.display_img|escape:'quotes':'UTF-8'}" /></a>
