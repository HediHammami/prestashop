    ...
    {if isset($purchase_togethers) && $purchase_togethers && count($purchase_togethers) != $alldisabled}
        ...
        {block name="purchase_together"}
                                ...
                                <span class="product-price-and-shipping">
                                    {*if $currProduct.has_discount}
                                        {if isset($configs.ETS_PT_DISPLAY_OLD_PRICE) && $configs.ETS_PT_DISPLAY_OLD_PRICE}
                                            ...
                                            <span class="regular-price">{$currProduct.regular_price}</span>
                                        {/if}
                                        {if $currProduct.discount_type === 'percentage' &&isset($configs.ETS_PT_DISPLAY_DISCOUNT) && $configs.ETS_PT_DISPLAY_DISCOUNT}
                                          <span class="discount-percentage">{$currProduct.discount_percentage}</span>
                                        {/if}
                                    {/if*}
                        ...
                        <div class="row-product">
                            ...
                            <div class="ets_purchase_item_des">
                                <label for="purchase_{$product.id_product|intval}_{$product.id_product_attribute|intval}">
                                      <span class="product-title"><a href="{$product.url|escape:'quotes':'UTF-8'}">{$product.name_attribute|truncate:100:'...'}</a></span>
                                </label>
                                {block name='product_price_and_shipping'}
        	...
        	<div class="button-container {if count($purchase_togethers) == $alldisabled}disabled{/if}">
        		<a class="ets_ajax_add_to_cart_button btn btn-primary" href="{$ajax_cart|escape:'quotes':'UTF-8'}" rel="nofollow" title="{l s='Add all products to cart' d='Shop.Theme'}">
...
{else}
    {if isset($purchase_togethers) && $purchase_togethers && count($purchase_togethers) != $alldisabled}
        ...
        {block name="purchase_together"}
                        ...
                        <div class="row-product">
                            <div class="ets_purchase_item_image">
                                ...
                                {block name='product_thumbnail'}
                                    <a href="{$currProduct.url|escape:'quotes':'UTF-8'}" class="thumbnail product-thumbnail">
                                      <img
                                        src = "{$currProduct.cover.bySize.small_default.url|escape:'quotes':'UTF-8'}"
                                        alt = "{$currProduct.cover.legend|escape:'html':'UTF-8'}"
                                        data-full-size-image-url = "{$currProduct.cover.small.url|escape:'quotes':'UTF-8'}"
                                      >
                                    </a>
                                {/block}     
                            </div>
                            ...
                            <div class="row-product">
                                <div class="ets_purchase_item_image">
                                    <input type="checkbox" class=""
                                        ...
                                        name="purchase_together[]" />
                                    {block name='product_thumbnail'}
                                    <a href="{$product.url|escape:'quotes':'UTF-8'}" class="thumbnail product-thumbnail">
                                      <img
                                        src = "{$product.cover.bySize.small_default.url|escape:'quotes':'UTF-8'}"
                                        alt = "{$product.cover.legend|escape:'html':'UTF-8'}"
                                        data-full-size-image-url = "{$product.cover.small.url|escape:'quotes':'UTF-8'}"
                                      >
                                    </a>
                                    {/block}
                                </div>
        	...
        	<div class="button-container {if count($purchase_togethers) == $alldisabled}disabled{/if}">
        		<a class="ets_ajax_add_to_cart_button btn btn-primary" href="{$ajax_cart|escape:'quotes':'UTF-8'}" rel="nofollow" title="{l s='Add all products to cart'}">
        			<span>{l s='Add all products to cart' d='Shop.Theme'}</span>
        		</a>
        	</div>
