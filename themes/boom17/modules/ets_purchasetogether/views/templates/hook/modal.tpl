            ...
            {foreach from=$products item=product}
                <div class="row">
                  <div class="col-md-5 col-xs-5 product-image-modal">
                    <img class="product-image" src="{$product.product.cover.medium.url|escape:'quotes':'UTF-8'}" alt="{$product.product.cover.legend|escape:'html':'UTF-8'}" title="{$product.product.cover.legend|escape:'html':'UTF-8'}" itemprop="image">
                  </div>
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <div class="cart-content-btn">
                ...
                <a href="{$cart_url|escape:'quotes':'UTF-8'}" class="btn btn-primary"><i class="material-icons">&#xE876;</i>{l s='proceed to checkout' d='Shop.Theme.Actions'}</a>
              </div>
            </div>
          </div>
        </div>
