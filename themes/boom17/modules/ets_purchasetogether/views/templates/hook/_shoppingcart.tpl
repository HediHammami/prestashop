...
<div id="_desktop_cart" data-refresh-url="{$refresh_url|escape:'quotes':'UTF-8'}">
  <div class="blockcart cart-preview {if $cart.products_count > 0}active{else}inactive{/if}" data-refresh-url="{$refresh_url|escape:'quotes':'UTF-8'}">
    ...
    <div class="body cart-hover-content">
          ...
          <div class="cart-wishlist-action">
              ...
              <a class="cart-wishlist-checkout" href="{$urls.pages.order|escape:'quotes':'UTF-8'}">{l s='Check Out' d='Shop.Theme.Actions'}</a>
            </div>
      </div>
      <!-- end -->
  </div>
