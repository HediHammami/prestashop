...
<a  class="remove-from-cart"
    rel="nofollow"
    href="{$product.remove_from_cart_url|escape:'quotes':'UTF-8'}"
        ...
        <ul>
            {foreach from=$product.customizations item='customization'}
                <li>
                    ...
                    <a href="{$customization.remove_from_cart_url|escape:'quotes':'UTF-8'}" title="{l s='remove from cart' d='Shop.Theme.Actions'}" class="remove-from-cart" rel="nofollow">{l s='Remove' d='Shop.Theme.Actions'}</a>
                    <ul>
                        {foreach from=$customization.fields item='field'}
                            <li>
                                ...
                                {elseif $field.type == 'image'}
                                    <img src="{$field.image.small.url|escape:'quotes':'UTF-8'}">
                                {/if}
                            </li>
                        {/foreach}
                    </ul>
