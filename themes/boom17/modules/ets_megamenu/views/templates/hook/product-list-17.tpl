          ...
          <div class="thumbnail-container">
            {block name='product_thumbnail'}
              <a href="{$product.url|escape:'quotes':'UTF-8'}" class="thumbnail product-thumbnail">
                <img src = "{$product.cover.bySize.home_default.url|escape:'quotes':'UTF-8'}" alt = "{$product.cover.legend|escape:'html':'UTF-8'}" data-full-size-image-url = "{$product.cover.large.url|escape:'quotes':'UTF-8'}" >
              </a>
            {/block}
            <div class="product-description">
              {block name='product_name'}
                <h3 class="h3 product-title" itemprop="name"><a href="{$product.url|escape:'quotes':'UTF-8'}">{$product.name|escape:'html':'UTF-8'|truncate:30:'...'}</a></h3>
              {/block}
